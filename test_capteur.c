...
int test_capteur_couleur() {
    ...
    printf("\n--- Statistiques ---\n");
    printf("Rouge:       %d/10 (%.0f%%)\n", compteur_rouge, compteur_rouge * 10.0);
    printf("Vert:        %d/10 (%.0f%%)\n", compteur_vert, compteur_vert * 10.0);
    printf("Indéterminé: %d/10 (%.0f%%)\n", compteur_indetermine, compteur_indetermine * 10.0);
